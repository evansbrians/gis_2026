---
title: "Module 5: Advanced shapefiles and introduction to rasters"
format:
  html:
    embed-resouces: true
    self-contained: true
...
In this module we will complete our introduction to shapefiles (but there will be more to come!) by exploring some additional tools that you can use to get information from the shapefiles, such as the distance between shapes, shape area, and memory management. We will also take our first steps into working with raster data! Specifically, you will learn:

* How to conduct geometric operations in *sf*
...
* **5.1 Advanced sf**: This written tutorial and *optional* video lesson (runtime: 39:39) covers the geometric operations in *sf* that really enhance our ability to apply the package to a whole range of ecological applications. We have also included a section that provides instructions on which spatial joins are appropriate for different use cases and adds a few new joins along the way!
...
**[observatory_nets.geojson]{.mono}**: A point shapefile of mist net locations at our banding station at the Bird Observatory, an exhibit, research, and outreach center that is run by Tara and I (and the location of our office for Friday Q & A sessions!).
...
We have now accumulate a lot of terminology in this course. As such I now provide a glossary for all terms across our course content thus far!
...
-   **Minimum convex polygon**: The smallest polygon that contains all point features in a shapefile and does not have any angles greater than 180$^\circ$.
...
render_function_table("functions_through_module_5.csv", .align = c("c", "c", "l", "l"))
```
...
-   [5.2 Geometric operations on vector data](https://r.geocompx.org/geometry-operations#geo-vec){target="_blank"}
