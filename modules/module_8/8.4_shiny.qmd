...
**Important!** The website for the written portion of this lesson can be a bit dodgy. If you have issues with disconnecting (you almost certainly will), I recommend knitting the RMarkdown file `dashboard_app.Rmd`.
