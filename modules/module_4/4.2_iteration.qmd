...
**[dc_census.shp]{.mono}**: A polygon shapefile of census tracts in the District of Columbia. The data are in a projected coordinate system (datum = WGS84, projection is UTM, Zone 18N) with the EPSG code 32618. The data include the following fields:
...
**[weather_tidy.rds]{.mono}**: The data are formatted as a list object comprised of the following tibble data frames and variables:
...
render_function_table("functions_4.2_iteration.csv")
```
