...
<script>
window.parsonsProblems = window.parsonsProblems || []; window.parsonsProblems.push({ id: "p-1-5-01", maxDistractors: 1, code: "clean_df <-\n  rename(\n    bad_df,\n    bed = BED,\n    light_access = LightAccess\n  )\nrename(bed = BED, bad_df) #distractor" });
</script>
:::
...
<script>
window.parsonsProblems = window.parsonsProblems || []; window.parsonsProblems.push({ id: "p-1-5-02", maxDistractors: 1, code: "my_list_add_names %>%\n  names() %>%\n  tolower() %>%\n  set_names(my_list_add_names, .)\nset_names(., my_list_add_names) #distractor" });
</script>
:::
