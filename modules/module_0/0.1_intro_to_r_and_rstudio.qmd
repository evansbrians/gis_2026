...
*Note: The Output Pane also contains tools for a number of other tasks, including tools for loading and installing libraries and managing files.*
...
`r longmcq(c(answer = "Source Pane", "Console pane", "Output Pane", "History tab"))`
