...
* [Keyboard shortcuts and file paths are provided in the monospace font-family.]{style="font-family: monospace;"}. A table of keyboard shortcuts is provided at the end of each lesson.

*  :::{style="font-family: monospace; background-color: #f0f0f0; font-size: 0.75em;"}
Sections that appear exactly as they would in R are provided in the monospace font-family and are highlighted in gray. A table of functions used is provided at the end of each lesson.
:::
...
1. If you do not have *the most recent version* of {{< fa brands r-project size=1.5em >}} (≥ `r glue::glue("{R.version$major}.{R.version$minor} -- {R.version$nickname}")`) installed on your computer, <a href="https://www.r-project.org/" target="_blank"> **please visit this link**</a> and follow the directions to do so.
...
![](../../src/images/global_opts_2.png){style="width: 100%;" fig-alt="Screenshot highlighting settings described above"}
...
* Avoid including spaces in your folders or filenames -- when writing in code, spaces can cause problems for some command-line tools and external software. For example, we will use the bash shell in this course and spaces in that system carry real meaning!
...
* Avoid including uppercase letters in your filename. Consistent capitalization and using lowercase letters improve readability and avoid case-related mistakes.
