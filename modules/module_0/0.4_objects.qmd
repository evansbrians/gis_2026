...
<button id="p-0-4-01-check" class="btn btn-outline-dark btn-sm" type="button">Check My Order</button>
<button id="p-0-4-01-reset" class="btn btn-outline-dark btn-sm" type="button">Shuffle Again</button>
...
<div style="clear: both;"></div>
<button id="p-0-4-02-check" class="btn btn-outline-dark btn-sm" type="button">Check My Order</button>
<button id="p-0-4-02-reset" class="btn btn-outline-dark btn-sm" type="button">Shuffle Again</button>
...
<div style="clear: both;"></div>
<button id="p-0-4-03-check" class="btn btn-outline-dark btn-sm" type="button">Check My Order</button>
<button id="p-0-4-03-reset" class="btn btn-outline-dark btn-sm" type="button">Shuffle Again</button>
