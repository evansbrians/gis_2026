...
For example, you actually used an R function when you ran `1 + 2`. The plus sign is an R function called an **operator**.
...
* `c` is the name of the R function that is used to combine multiple values into a single object
...
* The commas are syntax which separate the arguments of the function (*Note: commas are not functions*)
...
The value of using an operator is that it can simplify common tasks.
:::
...
::: now_you
{{< fa user-circle size=2x >}} [What does the `na.rm = TRUE` argument do in `mean(c(5, 8, 13, NA), na.rm = TRUE)`?]{style="padding-left: 0.5em;"}
...
::: now_you
{{< fa user-circle size=2x >}} [Parsons Problem: Reorder the lines below into a valid nested function call that calculates the mean of `c(5, 8, 13, NA)`, ignoring the missing value. One line doesn't belong -- leave it in the trash.]{style="padding-left: 0.5em;"}
...
<button id="p-0-2-01-check" class="btn btn-outline-dark btn-sm" type="button">Check My Order</button>
<button id="p-0-2-01-reset" class="btn btn-outline-dark btn-sm" type="button">Shuffle Again</button>
...
::: now_you
{{< fa user-circle size=2x >}} [Parsons Problem: Reorder the lines below into the correct install, load, use sequence. Two lines don't belong -- leave them in the trash.]{style="padding-left: 0.5em;"}

<div class="parsons-problem">
<div id="p-0-2-02-trash" class="sortable-code"></div>
<div id="p-0-2-02-sortable" class="sortable-code"></div>
<div style="clear: both;"></div>
<button id="p-0-2-02-check" class="btn btn-outline-dark btn-sm" type="button">Check My Order</button>
<button id="p-0-2-02-reset" class="btn btn-outline-dark btn-sm" type="button">Shuffle Again</button>
...
<div style="clear: both;"></div>
<button id="p-0-2-03-check" class="btn btn-outline-dark btn-sm" type="button">Check My Order</button>
<button id="p-0-2-03-reset" class="btn btn-outline-dark btn-sm" type="button">Shuffle Again</button>
