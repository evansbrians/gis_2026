...
-   **Module 3: Introduction to shapefiles** (7-13 Sep): This module is our first foray in using R as a GIS and explores creating and using shapefiles with the *sf* package.
...
-   **Module 7: Advanced rasters and spatial patterns** (5-11 Oct): We will push the envelope a bit further by addressing concepts such as conducting terrain analyses of raster data, deriving density and distance rasters, and toe-dipping into the all-important concept of spatial autocorrelation.
