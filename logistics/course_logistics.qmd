  ...
  html:
    ...
    include-in-header:
      text: |
        ...
        <link rel="icon" type="image/png" href="../src/images/hex_icon.png" />
...
![](../src/images/gis_logo.png){.gis_logo}
...
To get the most out of sharing code in the discussion board, we strongly recommend using Canvas’s tool for inputting code. To do so, click the button {;} (choose any code language you like … they don’t have R). If you do not see the code button, click the ellipses (…) to view more formatting options.
...
|---------------|:-------------:|:-------------:|:-------------:|---------------|
| Review session  |  Mondays  | 10:30 - 11:45 | [Link](https://smithsonian.zoom.us/j/85331426725?pwd=aXLbaMUMYCbnWK0zCdX4r18NBRXLFR.1){target="_blank"} | Review problem set key                   |
| Office hours^†^ | Thursdays | 08:00 - 09:30 | [Link](https://smithsonian.zoom.us/j/89623119028?pwd=uxgPBnsrO30LdsclWuazl0XQXw2w5g.1){target="_blank"} | Course-relevant, one-on-one help session |
| Q & A session   |  Fridays  | 10:45 - 11:30 | [Link](https://smithsonian.zoom.us/j/84104276219?pwd=Ab9SqxqsonbGFlNW6nhphRM1qQZzwK.1){target="_blank"} | Address questions regarding problem sets |
| Office hours^†^ |  Fridays  | 13:30 - 14:45 | [Link](https://smithsonian.zoom.us/j/82588103885?pwd=OKVaBVepxaPYFAvERiEINb1jbSubVe.1){target="_blank"} | Course-relevant, one-on-one help session |
...
-   **Review session link** (Zoom): Click [this link](https://smithsonian.zoom.us/j/85331426725?pwd=aXLbaMUMYCbnWK0zCdX4r18NBRXLFR.1){target="_blank"} to join the review session.
...
-   **Q & A session link** (Zoom): Click [this link](https://smithsonian.zoom.us/j/84104276219?pwd=Ab9SqxqsonbGFlNW6nhphRM1qQZzwK.1){target="_blank"} to join the Q & A session.
...
-   **Signing up for office hours**: Office hours are by appointment only. Please sign up for your appointment at [this link](https://docs.google.com/spreadsheets/d/1GjALqK3jdjjrVjapRY6tMVJmHa8dcrKvbNyGHYP91cQ/edit?usp=sharing){target="_blank"}.
-   **Office hours link**: Please use the links in the table above or in the office hours spreadsheet to sign into your office hour session.
...
**Important**! For questions regarding clarification of code or methodology, please consult with your peers using the Canvas discussion board! This is meant to be a peer-to-peer learning device -- we will monitor the discussion board but will only weigh in if/when we deem it necessary.
